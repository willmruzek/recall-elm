...
var _user$project$Main$indexGenerator = F2(
	function (edgeSize, sampleSize) {
		return A2(
			_elm_lang$core$Random$map,
			A2(_elm_lang$core$Array$slice, 0, sampleSize),
						...
						A2(
							...
							function (i) {
								return A3(
									...
									A2(_elm_lang$core$List$repeat, edgeSize, i),
									_elm_lang$core$Native_List.range(0, edgeSize - 1));
							},
							_elm_lang$core$Native_List.range(0, edgeSize - 1))))));
	});
var _user$project$Main$squareMatrixGenerator = F3(
	function (edgeSize, sampleSize, value) {
		var indexes = A2(_user$project$Main$indexGenerator, edgeSize, sampleSize);
		var invertPoint = function (_p0) {
			var _p1 = _p0;
			return A2(
				_elm_community$array_extra$Array_Extra$update,
				_p1._0,
				A2(_elm_community$array_extra$Array_Extra$update, _p1._1, _elm_lang$core$Basics$not));
		};
		var initialMatrix = A2(
			_elm_lang$core$Array$repeat,
			edgeSize,
			A2(_elm_lang$core$Array$repeat, edgeSize, value));
		return A2(
			_elm_lang$core$Random$map,
			A2(_elm_lang$core$Array$foldl, invertPoint, initialMatrix),
			indexes);
	});
var _user$project$Main$generateSquareMatrix = F2(
	function (num, value) {
		return A2(
			_elm_lang$core$Array$repeat,
			num,
			A2(_elm_lang$core$Array$repeat, num, value));
	});
var _user$project$Main$Model = F6(
	function (a, b, c, d, e, f) {
		return {board: a, expectedBoard: b, gameOver: c, playerWon: d, turnCount: e, isDisabled: f};
	});
var _user$project$Main$AfterSleep = function (a) {
	return {ctor: 'AfterSleep', _0: a};
};
var _user$project$Main$NewBoard = function (a) {
	return {ctor: 'NewBoard', _0: a};
};
var _user$project$Main$ShuffleBoard = {ctor: 'ShuffleBoard'};
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						ctor: '_Tuple2',
						_0: 'is-hidden',
						_1: _elm_lang$core$Basics$not(model.gameOver)
					}
					]))
			]),
		_elm_lang$core$Native_List.fromArray(
			[
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								ctor: '_Tuple2',
								_0: 'is-hidden',
								_1: _elm_lang$core$Basics$not(model.playerWon)
							}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Events$onClick(_user$project$Main$ShuffleBoard)
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Do it again!')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								{ctor: '_Tuple2', _0: 'is-hidden', _1: model.playerWon}
							]))
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Whomp... Sorry'),
						A2(
						_elm_lang$html$Html$button,
						_elm_lang$core$Native_List.fromArray(
							[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Try again...')
							]))
					]))
			]));
};
var _user$project$Main$SelectTile = F2(
	function (a, b) {
		return {ctor: 'SelectTile', _0: a, _1: b};
	});
var _user$project$Main$grid = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('recall-grid')
			]),
				...
				F2(
					function (idy, row) {
						return A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[
									_elm_lang$html$Html_Attributes$class('recall-grid-row')
								]),
							_elm_lang$core$Array$toList(
								A2(
									_elm_lang$core$Array$indexedMap,
											...
											return A2(
												...
												_elm_lang$core$Native_List.fromArray(
													[
														...
														_elm_lang$core$Native_List.fromArray(
															[
																{ctor: '_Tuple2', _0: 'recall-grid-tile', _1: true},
																{ctor: '_Tuple2', _0: 'is-selected', _1: tile}
															])),
														_elm_lang$html$Html_Events$onClick(
														A2(_user$project$Main$SelectTile, idx, idy))
													]),
												_elm_lang$core$Native_List.fromArray(
													[]));
										}),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Recall')
					])),
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Select the nine tiles you see to win!')
					])),
				_user$project$Main$header(model),
				_user$project$Main$grid(model)
			]));
};
var _user$project$Main$NoOp = function (a) {
	return {ctor: 'NoOp', _0: a};
};
var _user$project$Main$initializeGame = _elm_lang$core$Platform_Cmd$batch(
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			_elm_lang$core$Random$generate,
			_user$project$Main$NewBoard,
			A3(_user$project$Main$squareMatrixGenerator, 5, 9, false)),
			A3(
			_elm_lang$core$Task$perform,
			_user$project$Main$NoOp,
			_user$project$Main$AfterSleep,
			_elm_lang$core$Process$sleep(3 * _elm_lang$core$Time$second))
		]));
var _user$project$Main$initModel = {
	ctor: '_Tuple2',
	_0: {
		board: A2(_user$project$Main$generateSquareMatrix, 5, false),
		expectedBoard: _elm_lang$core$Array$fromList(
			_elm_lang$core$Native_List.fromArray(
				[])),
		gameOver: false,
		playerWon: false,
		...
		switch (_p2.ctor) {
			...
			case 'SelectTile':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{turnCount: newTurnCount, board: newBoard, gameOver: newGameOver, playerWon: newPlayerWon}),
			...
			case 'ShuffleBoard':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{turnCount: 0, playerWon: false, gameOver: false, isDisabled: true}),
					_1: _user$project$Main$initializeGame
				};
			case 'NewBoard':
				var _p5 = _p2._0;
